                            ...
                            <div class="vehicle-info">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="vehicle-info-baggage" id="vehicle-info-baggage">: {{ trans_choice('baggage_count', ($transfer['adultQuantity'] + $transfer['kidQuantity'] + $transfer['babyQuantity']) * 2, ['count' => ($transfer['adultQuantity'] + $transfer['kidQuantity'] + $transfer['babyQuantity']) * 2])  }}</td>
                                    </tr>
                                    <tr>
